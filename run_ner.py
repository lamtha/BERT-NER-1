...
class NerProcessor(DataProcessor):
    ...
    def get_labels(self):
        return ['O','B-PESSOA','I-TEMPO','I-LOCAL','B-JURISPRUDENCIA','I-LEGISLACAO','B-ORGANIZACAO','B-LEGISLACAO','I-JURISPRUDENCIA','B-TEMPO','O','I-PESSOA','B-LOCAL','I-ORGANIZACAO' ,'X', '[CLS]', '[SEP]']
